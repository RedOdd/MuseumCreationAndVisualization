...
namespace RuntimeGizmos
{
	...
	public class TransformGizmo : MonoBehaviour
	{
		...
		public TransformType transformType = TransformType.All;
		...
		public KeyCode SetMoveType = KeyCode.Tilde;// KeyCode.W;
		public KeyCode SetRotateType = KeyCode.Tilde;//KeyCode.E;
		public KeyCode SetScaleType = KeyCode.Tilde;//KeyCode.R;
													//public KeyCode SetRectToolType = KeyCode.T;
		public KeyCode SetAllTransformType = KeyCode.Tilde;//KeyCode.Y;
		public KeyCode SetSpaceToggle = KeyCode.Tilde;//KeyCode.X;
		public KeyCode SetPivotModeToggle = KeyCode.Tilde;//KeyCode.Z;
		public KeyCode SetCenterTypeToggle = KeyCode.Tilde;//KeyCode.C;
		public KeyCode SetScaleTypeToggle = KeyCode.Tilde;//KeyCode.S;
		public KeyCode translationSnapping = KeyCode.Tilde;//KeyCode.LeftControl;
		public KeyCode AddSelection = KeyCode.Tilde;//KeyCode.LeftShift;
		public KeyCode RemoveSelection = KeyCode.Tilde;//KeyCode.LeftControl;
		public KeyCode ActionKey = KeyCode.Tilde;//KeyCode.LeftShift; //Its set to shift instead of control so that while in the editor we dont accidentally undo editor changes =/
		public KeyCode UndoAction = KeyCode.Tilde;//KeyCode.Z;
		public KeyCode RedoAction = KeyCode.Tilde;//KeyCode.Y;
		...
		void GetTarget()
		{
			if(nearAxis == Axis.None && Input.GetMouseButtonDown(0))
			{
				...
				if(Physics.Raycast(myCamera.ScreenPointToRay(Input.mousePosition), out hitInfo, Mathf.Infinity, selectionMask))
				{
					...
					{
						AddTarget(target);
						//controller.GetComponent<UIController>().ObjectInSceneSelected(target.gameObject);
						controller.GetComponent<UIController>().OISButtonClicked(target.gameObject);
					}
					else if(isRemoving)
					{
						RemoveTarget(target);
